...
public class Tower : MonoBehaviour
{
    ...
    private void FireAt(GameObject target)
    {
        ...
        if (bulletScript != null)
        {
            ...
            bulletScript.Initialize((target.transform.position - transform.position).normalized, speed, gameObject, target, new string[] { "Enemy" }, towerData.GetPhysicAttack(level));
        }
        else
        {
